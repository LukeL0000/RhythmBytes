'''
It's a rhythm game which teaches people about computer units of measurement
Date created: 2021.6.10
'''
...
failscreen = arcade.load_texture("dist/textures/failscreen.jpg")

#Textures for the three different backgrounds
background = arcade.load_texture("dist/textures/background.jpg")
backgroundtwo = arcade.load_texture("dist/textures/backgroundtwo.jpg")
backgroundthree = arcade.load_texture("dist/textures/backgroundthree.png")

#Loads the unique coloring for the maplines and hitboxes
mapline = arcade.load_texture("dist/textures/maplines.jpg")

#Texture for key indicators (arrow signs)
leftarrow = arcade.load_texture("dist/textures/left.png")
downarrow = arcade.load_texture("dist/textures/down.png")
rightarrow = arcade.load_texture("dist/textures/right.png")

#Texture and information for tenth combo animation
comboten = arcade.load_texture("dist/textures/comboten.png")
comboten_width = 500
comboten_height = 740
comboten_x = 0 - comboten_width/2
comboten_y = comboten_height/2
comboten_axis = 25
excellent = arcade.load_texture("dist/textures/excellent.png")
excellent_width = 490
excellent_height = 80

#Texture and information for triangle on exit and restart button
exitbutton = arcade.load_texture("dist/textures/exitbutton.png")
...
hitsound = arcade.load_sound("dist/effects/hitsound.mp3")

#Sound effect for ever 10 combo
comboten_sound = arcade.load_sound("dist/effects/holycow.mp3")

#Sound effect for failing
failsound = arcade.load_sound("dist/effects/failsound.mp3")
...
def startscreen():
    arcade.draw_text("Rhythm Bytes", 560, 600, arcade.color.SILVER, font_size = 100, font_name = "Verdana")
    hitline()
    arcade.draw_text("Press space to begin", 670, 500, arcade.color.SILVER, font_size = 50, font_name = "Verdana")
...
def endscreen():
    ...
    arcade.draw_text("Exit", WIDTH*(1/3) - 15, HEIGHT/6 - 30, arcade.color.SILVER, font_size = 20, font_name = "Verdana")
    arcade.draw_text("Restart", WIDTH * (2/3) - 40, HEIGHT / 6 - 30, arcade.color.SILVER, font_size = 20, font_name="Verdana")
